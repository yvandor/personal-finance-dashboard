...
// (app/icon.tsx's /icon/192, /icon/512 and /icon/512-maskable, plus
// app/apple-icon.tsx's /apple-icon). Kept in one module rather than copied
// per route file so the four rendered variants cannot drift into being four
// slightly different logos -- the only things that legitimately differ
// between them are the canvas size and how much safe-zone padding the
// destination platform demands, both of which are parameters below.
//
