  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="rounded-md border border-border-strong p-2 text-muted outline-none transition-colors hover:bg-surface-hover hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
      >
